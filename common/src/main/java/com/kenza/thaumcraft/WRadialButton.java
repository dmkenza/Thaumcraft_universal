...
public class WRadialButton extends WWidget {
    ...
    public void paint(MatrixStack matrices, int x, int y, int mouseX, int mouseY) {
        ...
        float buttonHeight = getHeight()*px;
...
//            icon.paint(matrices, x+ICON_SPACING, y+(BUTTON_HEIGHT-iconSize)/2, iconSize);
            icon.paint(matrices, x + (width-iconSize)/2, (y+(height-iconSize)/2) , iconSize);
        }
     ...
     * @return this button
     */
    public WRadialButton setOnClick(@Nullable Runnable onClick) {
    ...
    public WRadialButton setEnabled(boolean enabled) {
    ...
    public WRadialButton setLabel(Text label) {
        this.label = label;
        return this;
    }
    ...
    public WRadialButton setAlignment(HorizontalAlignment alignment) {
     ...
     * @since 6.4.0
     */
    public WRadialButton setIconSize(int iconSize) {
     ...
     * @since 2.2.0
     */
    public WRadialButton setIcon(@Nullable Icon icon) {
        this.icon = icon;
        return this;
    }
